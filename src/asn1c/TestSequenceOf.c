...
static asn_TYPE_member_t asn_MBR_TestSequenceOf_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct TestSequenceOf, integer),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		0,
		&asn_DEF_integer_2,
		0,	/* Defer constraints checking to the member type */
	...
	{ ATF_NOFLAGS, 0, offsetof(struct TestSequenceOf, string),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		0,
		&asn_DEF_string_4,
		0,	/* Defer constraints checking to the member type */
	...
	{ ATF_NOFLAGS, 0, offsetof(struct TestSequenceOf, boolean),
		(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
		0,
		&asn_DEF_boolean_6,
		0,	/* Defer constraints checking to the member type */
	...
	{ ATF_NOFLAGS, 0, offsetof(struct TestSequenceOf, nested),
		(ASN_TAG_CLASS_CONTEXT | (3 << 2)),
		0,
		&asn_DEF_nested_8,
		0,	/* Defer constraints checking to the member type */
...
static const ber_tlv_tag_t asn_DEF_TestSequenceOf_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_TestSequenceOf_tag2el_1[] = {
...
static asn_SEQUENCE_specifics_t asn_SPC_TestSequenceOf_specs_1 = {
	sizeof(struct TestSequenceOf),
	offsetof(struct TestSequenceOf, _asn_ctx),
	asn_MAP_TestSequenceOf_tag2el_1,
